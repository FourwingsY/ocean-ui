...
class Dropdown extends react_1.PureComponent {
    ...
    renderValues() {
        ...
        return react_1.default.createElement(DropdownMulti_style_1.Values, null, value.map(this.renderValue));
    }
    renderLabel() {
        const { inputFocused } = this.state;
        const { value, label } = this.props;
        return react_1.default.createElement(DropdownMulti_style_1.Label, { asPlaceholder: !inputFocused && !value }, label);
    }
    renderInput() {
    ...
    render() {
        ...
        return (react_1.default.createElement(DropdownMulti_style_1.StyledDropdown, { className: classnames_1.default('dropdown', className), focused: inputFocused, hasValue: value.length > 0, innerRef: c => (this.wrapper = c) },
            react_1.default.createElement(DropdownMulti_style_1.DropdownControl, { onMouseDown: this.onMouseDownOnControl, onKeyDown: this.onKeyDown },
                ...
                react_1.default.createElement(If_1.default, { condition: value }, this.renderValues()),
