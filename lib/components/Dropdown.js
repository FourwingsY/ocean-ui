...
const defaultFilterOptions = (givenOptions, inputValue, labelKey) => {
...
class Dropdown extends react_1.Component {
    constructor() {
        ...
        this.onInputBlur = e => {
            this.setState(prevState => (Object.assign({}, prevState, { inputFocused: false, menuOpened: false })));
            this.props.onBlur(e);
        };
        this.onKeyDown = (e) => {
            switch (e.keyCode) {
        ...
        this.selectOption = (option) => () => {
            ...
            this.blurInput();
            this.setState(prevState => (Object.assign({}, prevState, { menuOpened: false, inputValue: '' })));
            this.props.onChange(option);
        };
        this.selectFocusedOption = () => {
            this.blurInput();
            this.setState(prevState => (Object.assign({}, prevState, { focusedOption: null, menuOpened: false, inputValue: '' })));
        ...
        this.renderValue = () => {
            ...
            return (react_1.default.createElement(Dropdown_style_1.Value, null,
                react_1.default.createElement(If_1.default, { condition: Boolean(value) }, valueRenderer(value, labelKey))));
        };
        this.renderOption = (option) => {
            const { valueKey, labelKey, optionRenderer, disableOption } = this.props;
            const { focusedOption } = this.state;
            const disabled = disableOption(option);
            return (react_1.default.createElement(Dropdown_style_1.Option, { className: classnames_1.default('dropdown-option', {
    ...
    renderLabel() {
        ...
        return react_1.default.createElement(Dropdown_style_1.Label, { asPlaceholder: !inputFocused && !value }, label);
    }
    renderInput() {
        const { inputValue } = this.state;
        return (react_1.default.createElement(Dropdown_style_1.Input, { innerRef: c => {
                this.input = c;
            }, value: inputValue, onChange: this.onInputChange, onFocus: this.onInputFocus, onBlur: this.onInputBlur }));
    }
    renderArrow() {
        return (react_1.default.createElement(Dropdown_style_1.ToggleArrow, { opened: this.state.menuOpened, onMouseDown: this.onMouseDownOnArrow, tabIndex: -1 }));
    }
    renderClear() {
        return (react_1.default.createElement(Dropdown_style_1.ClearButton, { className: "dropdown-clear", onClick: this.clearValue }, "\u00D7"));
    }
    renderMenu() {
        const { options: givenOptions, labelKey, noValidOptionMessage } = this.props;
        const { inputValue } = this.state;
        this.filteredOptions = this.props.filterOptions(givenOptions, inputValue, labelKey);
        return (react_1.default.createElement(Dropdown_style_1.Menu, { onMouseDown: this.onMouseDownOnMenu, innerRef: c => {
                this.menu = c;
            } },
    ...
    render() {
        ...
        return (react_1.default.createElement(Dropdown_style_1.StyledDropdown, { className: classnames_1.default('dropdown', className), focused: inputFocused, hasValue: Boolean(value) },
            react_1.default.createElement(Dropdown_style_1.DropdownControl, { onMouseDown: this.onMouseDownOnControl, onKeyDown: this.onKeyDown },
                react_1.default.createElement(If_1.default, { condition: Boolean(label) }, this.renderLabel()),
                react_1.default.createElement(If_1.default, { condition: Boolean(value) }, this.renderValue()),
                react_1.default.createElement(If_1.default, { condition: searchable && !disabled }, this.renderInput()),
                react_1.default.createElement(If_1.default, { condition: Boolean(value) && clearable && !disabled }, this.renderClear()),
                react_1.default.createElement(If_1.default, { condition: !disabled }, this.renderArrow())),
            react_1.default.createElement(If_1.default, { condition: Boolean(errorMessage) },
                react_1.default.createElement(Dropdown_style_1.ErrorMessage, null, errorMessage)),
