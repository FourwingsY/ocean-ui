...
class Dropdown extends react_1.PureComponent {
    constructor() {
        ...
        this.renderValue = () => {
            ...
            return (react_1.default.createElement(Dropdown_style_1.Value, null,
                react_1.default.createElement(If_1.default, { condition: value }, valueRenderer(value, labelKey))));
        };
    ...
    renderArrow() {
        return (react_1.default.createElement(Dropdown_style_1.ToggleArrow, { type: "button", opened: this.state.menuOpened, onMouseDown: this.onMouseDownOnArrow, tabIndex: -1 }));
    }
    renderClear() {
        return (react_1.default.createElement(Dropdown_style_1.ClearButton, { type: "button", className: "dropdown-clear", onClick: this.clearValue }, "\u2715"));
    }
    renderMenu() {
    ...
    render() {
        ...
        return (react_1.default.createElement(Dropdown_style_1.StyledDropdown, { className: classnames_1.default('dropdown', className), focused: inputFocused, hasValue: value },
            react_1.default.createElement(Dropdown_style_1.DropdownControl, { onMouseDown: this.onMouseDownOnControl, onKeyDown: this.onKeyDown },
                ...
                react_1.default.createElement(If_1.default, { condition: value && !inputFocused }, this.renderValue()),
                react_1.default.createElement(If_1.default, { condition: searchable && !disabled }, this.renderInput()),
                react_1.default.createElement(If_1.default, { condition: value && clearable && !disabled }, this.renderClear()),
